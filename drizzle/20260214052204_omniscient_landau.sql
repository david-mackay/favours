...
CREATE UNIQUE INDEX "auth_nonces_nonce_unique" ON "auth_nonces" USING btree ("nonce" text_ops);--> statement-breakpoint
CREATE INDEX "auth_nonces_wallet_idx" ON "auth_nonces" USING btree ("wallet_address" text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "users_wallet_address_unique" ON "users" USING btree ("wallet_address" text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "friendships_unique" ON "friendships" USING btree ("user_id_1" uuid_ops,"user_id_2" uuid_ops);--> statement-breakpoint
CREATE INDEX "friendships_user1_idx" ON "friendships" USING btree ("user_id_1" uuid_ops);--> statement-breakpoint
CREATE INDEX "friendships_user2_idx" ON "friendships" USING btree ("user_id_2" uuid_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "invites_code_idx" ON "invites" USING btree ("code" text_ops);--> statement-breakpoint
CREATE INDEX "invites_creator_idx" ON "invites" USING btree ("creator_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "reactions_post_idx" ON "reactions" USING btree ("post_id" uuid_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "reactions_user_post_emoji_unique" ON "reactions" USING btree ("user_id" text_ops,"post_id" text_ops,"emoji" text_ops);--> statement-breakpoint
CREATE INDEX "posts_reference_post_idx" ON "posts" USING btree ("reference_post_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "posts_target_user_idx" ON "posts" USING btree ("target_user_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "posts_user_idx" ON "posts" USING btree ("user_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "post_stacks_post_idx" ON "post_stacks" USING btree ("post_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "messages_receiver_idx" ON "messages" USING btree ("receiver_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "messages_sender_idx" ON "messages" USING btree ("sender_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "event_attendees_post_idx" ON "event_attendees" USING btree ("post_id" uuid_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "event_attendees_unique" ON "event_attendees" USING btree ("user_id" uuid_ops,"post_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "post_comments_post_idx" ON "post_comments" USING btree ("post_id" uuid_ops);
*/